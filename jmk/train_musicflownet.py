...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Optional run folder name. Default: full_s<seed>.",
    )
    parser.add_argument(
        "--build_mel",
        type=str_to_bool,
    ...
    parser.add_argument(
        ...
        default=True,
        help=(
            "Copy the best checkpoint to D:\\code\\codepy\\dl\\emf_v1_out\\best_emf_v1.pt "
...
def main() -> None:
    ...
    run_name = args.run_name.strip() or f"full_s{seed}"
    out_dir = run_root / run_name

    row = run_experiment_once(
        seed=seed,
        structure="full",
        temporal_kind="conformer",
        use_denoising=True,
        out_dir=out_dir,
